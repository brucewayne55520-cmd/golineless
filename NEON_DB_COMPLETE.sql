...
CREATE TABLE IF NOT EXISTS "tasks" (
  ...
  -- Payment (cash by default for pilot mode)
...
-- Tasks (10 indexes for common query patterns)
...
-- Subscription plans (upsert: safe to re-run)
...
-- Default admin settings row (singleton — safe to re-run)
...
--   1. Uncomment the DROP section at the top of this file
--   2. Run the file
--   3. Comment the DROP section back
-- ============================================================
