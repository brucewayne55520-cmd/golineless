...
const TYPE_ICONS: Record<string, typeof Bell> = {
  ...
  task_on_the_way: Package,
  task_in_progress: Package,
};
    ...
    <div className="min-h-screen bg-[#F8F9FC] pb-24">
      ...
      <div className="bg-white border-b border-gray-100 px-4 py-4 flex items-center justify-between sticky top-0 z-10">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="font-black text-[#1A1A2E] text-lg">Notifications</h1>
            {unreadCount > 0 && (
      ...
      <div className="px-4 pt-3">
        {isLoading ? (
          ...
          <div className="text-center py-20">
            ...
            <p className="text-gray-300 text-xs mt-1">You'll see task updates, KYC status, and payment confirmations here</p>
          </div>
        ) : (
          <div className="space-y-2">
            {notifs.map(notif => {
              ...
              return (
                <button
                  ...
                  onClick={() => {
                    ...
                    if (notif.taskId) navigate(`/app/tasks/${notif.taskId}`);
                  }}
                  ...
                  <div className="flex gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-0.5">
                        <h3 className={`text-sm font-bold truncate ${notif.isRead ? "text-gray-600" : "text-[#1A1A2E]"}`}>
                          {notif.title}
                        </h3>
                        {!notif.isRead && (
                      ...
                      <div className="flex items-center gap-2 mt-1.5">
                        ...
                        {notif.taskId && (
                          <>
                            ...
                            <span className="text-[10px] text-gray-400 font-mono">Task #{notif.taskId}</span>
                          </>
                        )}
                      </div>
                    </div>
                    {!notif.isRead && markingId !== notif.id && (
                      <button
                        ...
                        className="w-7 h-7 rounded-lg bg-gray-100 flex items-center justify-center hover:bg-gray-200 transition-colors flex-shrink-0"
                      >
